          ...
          <div className="p-3 space-y-3">
              {upcomingPayments.map((inst, idx) => (
                  <div 
                    ...
                    className={`p-4 rounded-xl border flex justify-between items-center cursor-pointer transition-all active:scale-[0.98] ${inst!.isDueSoon ? 'bg-orange-50 border-orange-200 ring-2 ring-orange-200 ring-offset-2' : 'bg-gray-50 border-gray-100'}`}
                  >
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span 
                          className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase transition-transform ${getUserColor(inst!.userName)}`}
                        >
                          {inst!.userName}
                        </span>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[8px] text-gray-300 font-bold">• ক্লিক করে বিস্তারিত দেখুন</span>
                      </div>
                    </div>
